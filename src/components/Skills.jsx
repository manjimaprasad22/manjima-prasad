...
const Skills = () => {
  ...
  return (
    <div>
      <Slider {...settings}>
      {[react, redux, rest, git, html, css, bootstrap, mui, node, db, express].map((src, index) => (
          ...
          <div className="card" style={{ width: "8rem", backgroundColor: "transparent", border: "none" }}>
            ...
            <div className="card-body">
              <h5 className="card-title card-name" style={{ color: "black", fontSize: "small" }}>
                ...
                {['React Js', 'Redux', 'Rest API', 'GitHub', 'HTML', 'CSS', 'Bootstrap', 'MUI', 'Node Js', 'MongoDB', 'Express'][index]}
              </h5>
            </div>
          </div>
        </div>
